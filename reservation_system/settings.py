...
SECRET_KEY = 'django-insecure-7(b94n17m4*z76ox%sx9jr3t6s52rq9f$p9a0gsk#arll7bfdn'
...
REST_FRAMEWORK = {
    # 'EXCEPTION_HANDLER': 'utils_manager.exception_handler.custom_exception_handler',
